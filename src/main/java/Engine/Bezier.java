...
public class Bezier extends Object{
    ...
    public Bezier(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<float[]> PointControl, float lineWidth) {
    ...
    public void draw(Camera camera, Projection projection) {
        ...
        // Draw the vertices
        //optional
        glLineWidth(this .lineWidth); //ketebalan garis
